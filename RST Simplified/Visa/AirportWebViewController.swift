//
//  AirportWebViewController.swift
//  RST Simplified
//
//  Created by RSTI E-Services on 01/12/17.
...
class AirportWebViewController: UIViewController, UIWebViewDelegate {
...
//
        webview.stringByEvaluatingJavaScript(from: "javascript:(function() { " +
            "var head = document.getElementsByTagName('navigation').remove(); + ()")
        
        webview.stringByEvaluatingJavaScript(from: "javascript:(function() { " +
            "var set = document.getElementsByClassName('navigation');"
